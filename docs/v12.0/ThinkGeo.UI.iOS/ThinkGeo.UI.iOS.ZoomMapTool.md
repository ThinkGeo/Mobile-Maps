...
|[`GlobeExtent`](#globeextent)|[`RectangleShape`](../ThinkGeo.Core/ThinkGeo.Core.RectangleShape.md)|Gets or sets the globe extent.|
...
|[`IsGlobeButtonVisiable`](#isglobebuttonvisiable)|`Boolean`|Gets or sets a value indicating whether this instance is globe button visiable.|
...
|[`MaxScale`](#maxscale)|`Double`|Gets or sets the maximum scale.|
...
|Name|Type|Description|
|---|---|---|
|mapView|[`MapView`](ThinkGeo.UI.iOS.MapView.md)|The map view.|
