...
|[`CurrentMap`](#currentmap)|[`MapView`](ThinkGeo.UI.iOS.MapView.md)|Gets or sets current map that the mapTool will be drawn on|
...
|[`IsEnabled`](#isenabled)|`Boolean`|Gets or sets a value indicating whether this instance is enabled.|
