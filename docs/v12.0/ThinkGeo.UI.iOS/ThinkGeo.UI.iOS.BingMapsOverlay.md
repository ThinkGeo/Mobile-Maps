...
|---|---|---|
|[`ApplicationId`](#applicationid)|`String`|This property gets or sets an application account registered from Bing Maps Imagery Service.|
...
|[`Logo`](#logo)|[`GeoImage`](../ThinkGeo.Core/ThinkGeo.Core.GeoImage.md)|Gets or sets the logo.|
|[`MapArguments`](#maparguments)|[`MapArguments`](ThinkGeo.UI.iOS.MapArguments.md)|N/A|
|[`MapStyle`](#mapstyle)|[`BingMapsMapType`](../ThinkGeo.Core/ThinkGeo.Core.BingMapsMapType.md)|This property gets or sets the requesting map type from Bing Maps Imagery Service.|
