...
public partial class RoutingTspCloudServices
{
    ...
    private async Task<CloudRoutingOptimizationResult> GetOptimizedRoute()
    {
        ...
        var optimizedRoutingResult =
            await _routingCloudClient.GetOptimizedRouteAsync(_routingWaypoints, 3857, options);
    ...
    private async void RouteWaypoints()
    {
        ...
        {
            await DisplayAlertAsync("Alert", optimizedRoutingResult.Exception.Message, "OK");
            return;
        }
