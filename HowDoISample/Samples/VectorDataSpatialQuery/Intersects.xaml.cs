...
public partial class Intersects
{
    ...
    private async void Intersects_OnSizeChanged(object sender, EventArgs e)
    {
        if (_initialized)
            return;
        _initialized = true;
    ...
    /// </summary>
    private async Task GetFeaturesIntersects(BaseShape polygon)
    {
