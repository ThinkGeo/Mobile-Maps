...
public partial class DifferenceShapes
{
    ...
    private async void Map_OnSizeChanged(object sender, EventArgs e)
    {
        ...
        // Style cityLimits layer
        westRegionLayer.ZoomLevelSet.ZoomLevel01.DefaultAreaStyle =
            AreaStyle.CreateSimpleAreaStyle(new GeoColor(32, GeoColors.Blue), GeoColors.DimGray);
        westRegionLayer.ZoomLevelSet.ZoomLevel01.ApplyUntilZoomLevel = ApplyUntilZoomLevel.Level20;

        // Style the differenceLayer
        differenceLayer.ZoomLevelSet.ZoomLevel01.DefaultAreaStyle =
    ...
    private async void DifferenceShape_OnClick(object sender, EventArgs e)
    {
        ...
        var differenceOverlay = (LayerOverlay)Map.Overlays["differenceOverlay"];
