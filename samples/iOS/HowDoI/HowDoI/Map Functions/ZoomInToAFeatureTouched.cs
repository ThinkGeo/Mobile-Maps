...
namespace ThinkGeo.UI.iOS.HowDoI
{
    public class ZoomInToAFeatureTouched : BaseViewController
    {
        ...
        private void MapView_MapSingleTap(object sender, UIGestureRecognizer e)
        {
            ...
            PointShape worldLocation = MapUtil.ToWorldCoordinate(MapView.CurrentExtent, (float)location.X,
                (float)location.Y, (float)View.Frame.Width, (float)View.Frame.Height);
