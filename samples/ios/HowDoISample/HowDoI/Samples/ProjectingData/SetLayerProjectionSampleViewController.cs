...
{
    public partial class SetLayerProjectionSampleViewController : BaseController
    {
        public SetLayerProjectionSampleViewController() : base("SetLayerProjectionSampleViewController", null)
        {
            Title = "";
        }
