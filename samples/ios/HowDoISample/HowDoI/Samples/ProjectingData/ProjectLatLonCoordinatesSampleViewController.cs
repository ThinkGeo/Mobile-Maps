...
{
    public partial class ProjectLatLonCoordinatesSampleViewController : BaseController
    {
        public ProjectLatLonCoordinatesSampleViewController() : base("ProjectLatLonCoordinatesSampleViewController", null)
        {
            Title = "";
        }
