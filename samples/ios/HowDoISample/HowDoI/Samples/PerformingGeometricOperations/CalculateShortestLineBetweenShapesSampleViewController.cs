...
{
    public partial class CalculateShortestLineBetweenShapesSampleViewController : BaseController
    {
        public CalculateShortestLineBetweenShapesSampleViewController() : base("CalculateShortestLineBetweenShapesSampleViewController", null)
        {
            Title = "";
        }
