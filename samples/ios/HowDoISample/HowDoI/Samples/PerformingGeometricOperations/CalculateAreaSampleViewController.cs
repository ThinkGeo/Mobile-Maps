...
{
    public partial class CalculateAreaSampleViewController : BaseController
    {
        public CalculateAreaSampleViewController() : base("CalculateAreaSampleViewController", null)
        {
            Title = "";
        }
