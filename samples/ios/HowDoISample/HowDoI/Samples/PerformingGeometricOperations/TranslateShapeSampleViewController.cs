...
{
    public partial class TranslateShapeSampleViewController : BaseController
    {
        public TranslateShapeSampleViewController() : base("TranslateShapeSampleViewController", null)
        {
            Title = "";
        }
