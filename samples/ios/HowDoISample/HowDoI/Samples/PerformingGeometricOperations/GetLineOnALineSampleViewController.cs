...
{
    public partial class GetLineOnALineSampleViewController : BaseController
    {
        public GetLineOnALineSampleViewController() : base("GetLineOnALineSampleViewController", null)
        {
            Title = "";
        }
