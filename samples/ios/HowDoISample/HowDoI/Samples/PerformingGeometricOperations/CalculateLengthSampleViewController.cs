...
{
    public partial class CalculateLengthSampleViewController : BaseController
    {
        public CalculateLengthSampleViewController() : base("CalculateLengthSampleViewController", null)
        {
            Title = "";
        }
