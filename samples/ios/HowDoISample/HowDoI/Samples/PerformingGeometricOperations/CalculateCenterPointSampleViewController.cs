...
{
    public partial class CalculateCenterPointSampleViewController : BaseController
    {
        public CalculateCenterPointSampleViewController() : base("CalculateCenterPointSampleViewController", null)
        {
            Title = "";
        }
