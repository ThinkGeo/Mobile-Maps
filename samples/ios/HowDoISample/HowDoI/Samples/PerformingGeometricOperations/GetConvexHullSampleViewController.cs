...
{
    public partial class GetConvexHullSampleViewController : BaseController
    {
        public GetConvexHullSampleViewController() : base("GetConvexHullSampleViewController", null)
        {
            Title = "";
        }
