...
{
    public partial class SimplifyShapeSampleViewController : BaseController
    {
        public SimplifyShapeSampleViewController() : base("SimplifyShapeSampleViewController", null)
        {
            Title = "";
        }
