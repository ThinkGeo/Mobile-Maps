...
{
    public partial class DifferenceShapesSampleViewController : BaseController
    {
        public DifferenceShapesSampleViewController() : base("DifferenceShapesSampleViewController", null)
        {
            Title = "";
        }
