...
{
    public partial class CommonRasterLayersSampleViewController : BaseController
    {
        public CommonRasterLayersSampleViewController() : base("CommonRasterLayersSampleViewController", null)
        {
            Title = "";
        }
