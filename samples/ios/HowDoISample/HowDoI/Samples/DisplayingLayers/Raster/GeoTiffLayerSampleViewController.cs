...
{
    public partial class GeoTiffLayerSampleViewController : BaseController
    {
        public GeoTiffLayerSampleViewController() : base("GeoTiffLayerSampleViewController", null)
        {
            Title = "";
        }
