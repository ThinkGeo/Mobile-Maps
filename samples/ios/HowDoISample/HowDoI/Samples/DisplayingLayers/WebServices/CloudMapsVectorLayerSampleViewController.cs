...
{
    public partial class CloudMapsVectorLayerSampleViewController : BaseController
    {
        public CloudMapsVectorLayerSampleViewController() : base("CloudMapsVectorLayerSampleViewController", null)
        {
            Title = "";
        }
