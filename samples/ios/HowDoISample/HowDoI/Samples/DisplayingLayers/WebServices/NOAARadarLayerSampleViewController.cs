...
{
    public partial class NOAARadarLayerSampleViewController : BaseController
    {
        public NOAARadarLayerSampleViewController() : base("NOAARadarLayerSampleViewController", null)
        {
            Title = "";
        }
