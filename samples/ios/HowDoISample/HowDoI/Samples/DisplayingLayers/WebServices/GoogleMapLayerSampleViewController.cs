...
{
    public partial class GoogleMapLayerSampleViewController : BaseController
    {
        public GoogleMapLayerSampleViewController() : base("GoogleMapLayerSampleViewController", null)
        {
            Title = "";
        }
