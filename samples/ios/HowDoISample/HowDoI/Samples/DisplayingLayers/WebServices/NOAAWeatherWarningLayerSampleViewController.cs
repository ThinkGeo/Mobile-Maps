...
{
    public partial class NOAAWeatherWarningLayerSampleViewController : BaseController
    {
        public NOAAWeatherWarningLayerSampleViewController() : base("NOAAWeatherWarningLayerSampleViewController", null)
        {
            Title = "";
        }
