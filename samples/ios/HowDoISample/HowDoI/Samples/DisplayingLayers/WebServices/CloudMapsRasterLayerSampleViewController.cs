...
{
    public partial class CloudMapsRasterLayerSampleViewController : BaseController
    {
        public CloudMapsRasterLayerSampleViewController() : base("CloudMapsRasterLayerSampleViewController", null)
        {
            Title = "";
        }
