...
{
    public partial class OpenStreetMapLayerSampleViewController : BaseController
    {
        public OpenStreetMapLayerSampleViewController() : base("OpenStreetMapLayerSampleViewController", null)
        {
            Title = "";
        }
