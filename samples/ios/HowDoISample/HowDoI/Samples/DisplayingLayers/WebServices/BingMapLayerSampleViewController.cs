...
{
    public partial class BingMapLayerSampleViewController : BaseController
    {
        public BingMapLayerSampleViewController() : base("BingMapLayerSampleViewController", null)
        {
            Title = "";
        }
