...
{
    public partial class NOAAWeatherStationLayerSampleViewController : BaseController
    {
        public NOAAWeatherStationLayerSampleViewController() : base("NOAAWeatherStationLayerSampleViewController", null)
        {
            Title = "";
        }
