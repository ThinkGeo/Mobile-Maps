...
{
    public partial class TinyGeoLayerSampleViewController : BaseController
    {
        public TinyGeoLayerSampleViewController() : base("TinyGeoLayerSampleViewController", null)
        {
            Title = "";
        }
