...
{
    public partial class InMemoryLayerSampleViewController : BaseController
    {
        public InMemoryLayerSampleViewController() : base("InMemoryLayerSampleViewController", null)
        {
            Title = "";
        }
