...
{
    public partial class ISOLineLayerSampleViewController : BaseController
    {
        public ISOLineLayerSampleViewController() : base("ISOLineLayerSampleViewController", null)
        {
            Title = "";
        }
