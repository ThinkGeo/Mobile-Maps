...
{
    public partial class FileGeoDatabaseLayerSampleViewController : BaseController
    {
        public FileGeoDatabaseLayerSampleViewController() : base("FileGeoDatabaseLayerSampleViewController", null)
        {
            Title = "";
        }
