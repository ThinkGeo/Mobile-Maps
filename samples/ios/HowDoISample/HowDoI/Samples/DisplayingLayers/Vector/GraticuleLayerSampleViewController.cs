...
{
    public partial class GraticuleLayerSampleViewController : BaseController
    {
        public GraticuleLayerSampleViewController() : base("GraticuleLayerSampleViewController", null)
        {
            Title = "";
        }
