...
{
    public partial class PostgresLayerSampleViewController : BaseController
    {
        public PostgresLayerSampleViewController() : base("PostgresLayerSampleViewController", null)
        {
            Title = "";
        }
