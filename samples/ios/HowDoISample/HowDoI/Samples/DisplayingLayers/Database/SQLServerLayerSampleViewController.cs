...
{
    public partial class SQLServerLayerSampleViewController : BaseController
    {
        public SQLServerLayerSampleViewController() : base("SQLServerLayerSampleViewController", null)
        {
            Title = "";
        }
