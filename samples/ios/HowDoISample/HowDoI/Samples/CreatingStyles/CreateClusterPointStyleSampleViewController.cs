...
{
    public partial class CreateClusterPointStyleSampleViewController : BaseController
    {
        public CreateClusterPointStyleSampleViewController() : base("CreateClusterPointStyleSampleViewController", null)
        {
            Title = "";
        }
