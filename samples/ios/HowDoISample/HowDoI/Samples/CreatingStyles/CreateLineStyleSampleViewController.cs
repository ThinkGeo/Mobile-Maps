...
{
    public partial class CreateLineStyleSampleViewController : BaseController
    {
        public CreateLineStyleSampleViewController() : base("CreateLineStyleSampleViewController", null)
        {
            Title = "";
        }
