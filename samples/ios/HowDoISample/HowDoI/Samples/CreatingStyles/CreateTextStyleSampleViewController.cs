...
{
    public partial class CreateTextStyleSampleViewController : BaseController
    {
        public CreateTextStyleSampleViewController() : base("CreateTextStyleSampleViewController", null)
        {
            Title = "";
        }
