...
{
    public partial class CreateValueStyleSampleViewController : BaseController
    {
        public CreateValueStyleSampleViewController() : base("CreateValueStyleSampleViewController", null)
        {
            Title = "";
        }
