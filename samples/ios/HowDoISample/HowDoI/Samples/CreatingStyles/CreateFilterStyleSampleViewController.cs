...
{
    public partial class CreateFilterStyleSampleViewController : BaseController
    {
        public CreateFilterStyleSampleViewController() : base("CreateFilterStyleSampleViewController", null)
        {
            Title = "";
        }
