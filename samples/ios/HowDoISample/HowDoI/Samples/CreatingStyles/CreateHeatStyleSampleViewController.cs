...
{
    public partial class CreateHeatStyleSampleViewController : BaseController
    {
        public CreateHeatStyleSampleViewController() : base("CreateHeatStyleSampleViewController", null)
        {
            Title = "";
        }
