...
{
    public partial class CreateAreaStyleSampleViewController : BaseController
    {
        public CreateAreaStyleSampleViewController() : base("CreateAreaStyleSampleViewController", null)
        {
            Title = "";
        }
