...
{
    public partial class StylingAcrossMultipleScalesSampleViewController : BaseController
    {
        public StylingAcrossMultipleScalesSampleViewController() : base("StylingAcrossMultipleScalesSampleViewController", null)
        {
            Title = "";
        }
