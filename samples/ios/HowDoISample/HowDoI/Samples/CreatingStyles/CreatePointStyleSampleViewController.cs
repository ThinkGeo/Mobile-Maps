...
{
    public partial class CreatePointStyleSampleViewController : BaseController
    {
        public CreatePointStyleSampleViewController() : base("CreatePointStyleSampleViewController", null)
        {
            Title = "";
        }
