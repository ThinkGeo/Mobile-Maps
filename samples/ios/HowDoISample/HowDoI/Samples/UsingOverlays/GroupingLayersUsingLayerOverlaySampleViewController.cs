...
{
    public partial class GroupingLayersUsingLayerOverlaySampleViewController : BaseController
    {
        public GroupingLayersUsingLayerOverlaySampleViewController() : base("GroupingLayersUsingLayerOverlaySampleViewController", null)
        {
            Title = "";
        }
