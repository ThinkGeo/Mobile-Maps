...
{
    public partial class UsingMarkersSampleViewController : BaseController
    {
        public UsingMarkersSampleViewController() : base("UsingMarkersSampleViewController", null)
        {
            Title = "";
        }
