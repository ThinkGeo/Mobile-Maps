...
{
    public partial class DisplayWMSOverlaySampleViewController : BaseController
    {
        public DisplayWMSOverlaySampleViewController() : base("DisplayWMSOverlaySampleViewController", null)
        {
            Title = "";
        }
