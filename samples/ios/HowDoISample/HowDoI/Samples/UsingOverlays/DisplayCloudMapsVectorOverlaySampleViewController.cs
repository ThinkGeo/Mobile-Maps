...
{
    public partial class DisplayCloudMapsVectorOverlaySampleViewController : BaseController
    {
        public DisplayCloudMapsVectorOverlaySampleViewController() : base("DisplayCloudMapsVectorOverlaySampleViewController", null)
        {
            Title = "";
        }
