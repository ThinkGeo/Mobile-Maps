...
{
    public partial class DisplayGoogleMapsOverlaySampleViewController : BaseController
    {
        public DisplayGoogleMapsOverlaySampleViewController() : base("DisplayGoogleMapsOverlaySampleViewController", null)
        {
            Title = "";
        }
