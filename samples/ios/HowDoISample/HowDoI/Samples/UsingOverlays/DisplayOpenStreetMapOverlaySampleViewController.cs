...
{
    public partial class DisplayOpenStreetMapOverlaySampleViewController : BaseController
    {
        public DisplayOpenStreetMapOverlaySampleViewController() : base("DisplayOpenStreetMapOverlaySampleViewController", null)
        {
            Title = "";
        }
