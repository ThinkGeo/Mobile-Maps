...
{
    public partial class DrawEditDeleteShapesUsingInteractiveOverlaySampleViewController : BaseController
    {
        public DrawEditDeleteShapesUsingInteractiveOverlaySampleViewController() : base("DrawEditDeleteShapesUsingInteractiveOverlaySampleViewController", null)
        {
            Title = "";
        }
