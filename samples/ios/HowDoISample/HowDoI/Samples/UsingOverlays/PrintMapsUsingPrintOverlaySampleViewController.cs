...
{
    public partial class PrintMapsUsingPrintOverlaySampleViewController : BaseController
    {
        public PrintMapsUsingPrintOverlaySampleViewController() : base("PrintMapsUsingPrintOverlaySampleViewController", null)
        {
            Title = "";
        }
