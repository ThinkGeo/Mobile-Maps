...
{
    public partial class DisplayCloudMapsRasterOverlaySampleViewController : BaseController
    {
        public DisplayCloudMapsRasterOverlaySampleViewController() : base("DisplayCloudMapsRasterOverlaySampleViewController", null)
        {
            Title = "";
        }
