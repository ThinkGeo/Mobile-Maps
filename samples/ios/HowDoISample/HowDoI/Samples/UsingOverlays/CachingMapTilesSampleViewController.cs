...
{
    public partial class CachingMapTilesSampleViewController : BaseController
    {
        public CachingMapTilesSampleViewController() : base("CachingMapTilesSampleViewController", null)
        {
            Title = "";
        }
