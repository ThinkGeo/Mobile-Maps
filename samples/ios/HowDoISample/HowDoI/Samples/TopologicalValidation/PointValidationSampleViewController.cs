...
{
    public partial class PointValidationSampleViewController : BaseController
    {
        public PointValidationSampleViewController() : base("PointValidationSampleViewController", null)
        {
            Title = "";
        }
