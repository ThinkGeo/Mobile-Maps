...
{
    public partial class LineValidationSampleViewController : BaseController
    {
        public LineValidationSampleViewController() : base("LineValidationSampleViewController", null)
        {
            Title = "";
        }
