...
{
    public partial class PolygonValidationSampleViewController : BaseController
    {
        public PolygonValidationSampleViewController() : base("PolygonValidationSampleViewController", null)
        {
            Title = "";
        }
