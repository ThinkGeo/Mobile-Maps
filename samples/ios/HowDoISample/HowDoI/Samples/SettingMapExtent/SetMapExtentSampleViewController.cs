...
{
    public partial class SetMapExtentSampleViewController : BaseController
    {
        public SetMapExtentSampleViewController() : base(" SetMapExtentSampleViewController", null)
        {
            Title = "";
        }
