...
{
    public partial class BasicNavigationSampleViewController : BaseController
    {
        public BasicNavigationSampleViewController() : base("BasicNavigationSampleViewController", null)
        {
            Title = "";
        }
