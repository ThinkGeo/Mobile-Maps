...
{
    public partial class GetDataFromFeatureSampleViewController : BaseController
    {
        public GetDataFromFeatureSampleViewController() : base("GetDataFromFeatureSampleViewController", null)
        {
            Title = "";
        }
