...
{
    public partial class GetAllFeatureDataSampleViewController : BaseController
    {
        public GetAllFeatureDataSampleViewController() : base("GetAllFeatureDataSampleViewController", null)
        {
            Title = "";
        }
