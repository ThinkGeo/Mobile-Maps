...
{
    public partial class GetFeaturesWithinDistanceSampleViewController : BaseController
    {
        public GetFeaturesWithinDistanceSampleViewController() : base("GetFeaturesWithinDistanceSampleViewController", null)
        {
            Title = "";
        }
