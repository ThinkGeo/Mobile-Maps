...
{
    public partial class DisplayMapMouseCoordinatesSampleViewController : BaseController
    {
        public DisplayMapMouseCoordinatesSampleViewController() : base("DisplayMapMouseCoordinatesSampleViewController", null)
        {
            Title = "";
        }
