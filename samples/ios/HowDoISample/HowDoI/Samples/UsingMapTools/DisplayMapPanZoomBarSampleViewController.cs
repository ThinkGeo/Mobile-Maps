...
{
    public partial class DisplayMapPanZoomBarSampleViewController : BaseController
    {
        public DisplayMapPanZoomBarSampleViewController() : base("DisplayMapPanZoomBarSampleViewController", null)
        {
            Title = "";
        }
