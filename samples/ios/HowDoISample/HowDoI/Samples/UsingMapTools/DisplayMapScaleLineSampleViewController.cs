...
{
    public partial class DisplayMapScaleLineSampleViewController : BaseController
    {
        public DisplayMapScaleLineSampleViewController() : base("DisplayMapScaleLineSampleViewController", null)
        {
            Title = "";
        }
