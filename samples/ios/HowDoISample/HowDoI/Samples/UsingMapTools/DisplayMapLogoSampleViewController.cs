...
{
    public partial class DisplayMapLogoSampleViewController : BaseController
    {
        public DisplayMapLogoSampleViewController() : base("DisplayMapLogoSampleViewController", null)
        {
            Title = "";
        }
