...
{
    public partial class InterpolationPlaceholderSampleViewController : BaseController
    {
        public InterpolationPlaceholderSampleViewController() : base("InterpolationPlaceholderSampleViewController", null)
        {
            Title = "";
        }
