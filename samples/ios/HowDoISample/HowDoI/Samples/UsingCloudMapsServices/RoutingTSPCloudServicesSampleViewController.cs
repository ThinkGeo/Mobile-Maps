...
{
    public partial class RoutingTSPCloudServicesSampleViewController : BaseController
    {
        public RoutingTSPCloudServicesSampleViewController() : base("RoutingTSPCloudServicesSampleViewController", null)
        {
            Title = "";
        }
