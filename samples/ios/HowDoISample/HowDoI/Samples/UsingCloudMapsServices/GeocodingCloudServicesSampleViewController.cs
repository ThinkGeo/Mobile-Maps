...
{
    public partial class GeocodingCloudServicesSampleViewController : BaseController
    {
        public GeocodingCloudServicesSampleViewController() : base("GeocodingCloudServicesSampleViewController", null)
        {
            Title = "";
        }
