...
{
    public partial class RoutingServiceAreaCloudServicesSampleViewController : BaseController
    {
        public RoutingServiceAreaCloudServicesSampleViewController() : base("RoutingServiceAreaCloudServicesSampleViewController", null)
        {
            Title = "";
        }
