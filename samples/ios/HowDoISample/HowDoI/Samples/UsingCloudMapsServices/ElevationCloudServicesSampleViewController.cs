...
{
    public partial class ElevationCloudServicesSampleViewController : BaseController
    {
        public ElevationCloudServicesSampleViewController() : base("ElevationCloudServicesSampleViewController", null)
        {
            Title = "";
        }
