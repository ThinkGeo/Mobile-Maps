...
{
    public partial class TimezoneCloudServicesSampleViewController : BaseController
    {
        public TimezoneCloudServicesSampleViewController() : base("TimezoneCloudServicesSampleViewController", null)
        {
            Title = "";
        }
