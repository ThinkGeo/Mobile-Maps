...
{
    public partial class ProjectionCloudServicesSampleViewController : BaseController
    {
        public ProjectionCloudServicesSampleViewController() : base("ProjectionCloudServicesSampleViewController", null)
        {
            Title = "";
        }
