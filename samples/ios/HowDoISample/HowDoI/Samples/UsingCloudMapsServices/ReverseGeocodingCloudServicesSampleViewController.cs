...
{
    public partial class ReverseGeocodingCloudServicesSampleViewController : BaseController
    {
        public ReverseGeocodingCloudServicesSampleViewController() : base("ReverseGeocodingCloudServicesSampleViewController", null)
        {
            Title = "";
        }
