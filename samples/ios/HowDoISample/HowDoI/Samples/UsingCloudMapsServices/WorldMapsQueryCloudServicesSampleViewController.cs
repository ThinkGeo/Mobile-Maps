...
{
    public partial class WorldMapsQueryCloudServicesSampleViewController : BaseController
    {
        public WorldMapsQueryCloudServicesSampleViewController() : base("WorldMapsQueryCloudServicesSampleViewController", null)
        {
            Title = "";
        }
