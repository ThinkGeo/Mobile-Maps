...
{
    public partial class RoutingCloudServicesSampleViewController : BaseController
    {
        public RoutingCloudServicesSampleViewController() : base("RoutingCloudServicesSampleViewController", null)
        {
            Title = "";
        }
