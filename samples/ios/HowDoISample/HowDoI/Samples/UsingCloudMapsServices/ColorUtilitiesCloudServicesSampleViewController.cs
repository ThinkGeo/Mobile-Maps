...
{
    public partial class ColorUtilitiesCloudServicesSampleViewController : BaseController
    {
        public ColorUtilitiesCloudServicesSampleViewController() : base("ColorUtilitiesCloudServicesSampleViewController", null)
        {
            Title = "";
        }
