...
namespace ThinkGeo.UI.Android.HowDoI
{
    ...
    public class UnionShapesSample : SampleFragment
    {
        ...
        public override void OnActivityCreated(Bundle savedInstanceState)
        {
            ...
            ShapeFileFeatureLayer dividedCityLimits = new ShapeFileFeatureLayer(Path.Combine(FileSystem.AppDataDirectory, "AppData/SampleData/Shapefile/FriscoCityLimitsDivided.shp"));
