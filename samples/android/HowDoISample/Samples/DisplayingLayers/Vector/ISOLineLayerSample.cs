...
{
    /// <summary>
    /// This sample shows how to display an ISOLine layer.
    /// </summary>
    public class ISOLineLayerSample : SampleFragment
    {
        ...
        private void SetupMap()
        {
            ...
            Dictionary<PointShape, double> csvPointData = GetDataFromCSV(@"mnt/sdcard/MapSuiteSampleData/HowDoISamples/AppData/SampleData/Csv/Frisco_Mosquitos.csv");
            ...
            var mosquitosLayer = new ShapeFileFeatureSource(@"mnt/sdcard/MapSuiteSampleData/HowDoISamples/AppData/SampleData/Shapefile/Frisco_Mosquitos.shp");
        ...
        private DynamicIsoLineLayer GetDynamicIsoLineLayer(Dictionary<PointShape, double> csvPointData)
        {
            ...
            dynamicIsoLineLayer.CellHeightInPixel = (int)(mapView.MeasuredHeight / 80);
            dynamicIsoLineLayer.CellWidthInPixel = (int)(mapView.MeasuredWidth / 80);
        ...
        // ========================================================
        // Code for creating the csv file from a point shapefile
        // ========================================================
