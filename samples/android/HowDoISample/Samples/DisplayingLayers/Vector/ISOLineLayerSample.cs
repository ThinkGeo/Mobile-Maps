...
namespace ThinkGeo.UI.Android.HowDoI
{
    ...
    public class ISOLineLayerSample : SampleFragment
    {
        ...
        public override void OnActivityCreated(Bundle savedInstanceState)
        {
            ...
            Dictionary<PointShape, double> csvPointData = GetDataFromCSV(Path.Combine(FileSystem.AppDataDirectory, "AppData/SampleData/Csv/Frisco_Mosquitos.csv"));
            ...
            var mosquitosLayer = new ShapeFileFeatureSource(Path.Combine(FileSystem.AppDataDirectory, "AppData/SampleData/Shapefile/Frisco_Mosquitos.shp"));
