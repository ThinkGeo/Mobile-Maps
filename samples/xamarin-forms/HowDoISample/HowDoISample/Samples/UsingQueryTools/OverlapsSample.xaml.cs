...
namespace ThinkGeo.UI.XamarinForms.HowDoI
{
    ...
    public partial class OverlapsSample
    {
        ...
        private async Task GetFeaturesOverlaps(PolygonShape polygon)
        {
            ...
            friscoLayer.Open();
            var queriedFeatures = friscoLayer.QueryTools.GetFeaturesOverlapping(polygon, ReturningColumnsType.AllColumns);
            ...
            txtNumberOfFeaturesFound.Text = $"Number of features overlapping the drawn shape: {queriedFeatures.Count}";            
        }
